...
export class RestClient {
   ...
   * cross-step atomicity; false keeps successes and fails only dependents.
   * NOT the /composite/sobjects collections endpoint. Success is per-subrequest
   * httpStatusCode — the top-level response is 200 even when subrequests failed.
   */
  async composite(
